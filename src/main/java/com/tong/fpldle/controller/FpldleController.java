package com.tong.fpldle.controller;

import com.tong.fpldle.api.IFpldleApi;
import com.tong.fpldle.domain.FpldleData;
import com.tong.fpldle.domain.FpleResultData;
...
public class FpldleController {
    ...
    public FpldleData getDailyFpldle(@RequestParam String date) {
        return this.fpldleApi.getDailyFpldle(date);
    }
